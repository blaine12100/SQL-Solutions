...
-- Calculate average using the parition by and order by technique (Very very powerful for user level aggregations)
-- The rows between technique needs to be studied. Used this link for reference --https://learnsql.com/blog/rolling-average-in-sql/
-- ROWS BETWEEN https://www.geeksforgeeks.org/sql-rows-between/
